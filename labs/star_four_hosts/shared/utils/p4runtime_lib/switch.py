...
class SwitchConnection(object):
    ...
    def InsertDigest(self, digest_id, dry_run=False):
        request = p4runtime_pb2.WriteRequest()
        request.device_id = self.device_id
        request.election_id.low = 1
        update = request.updates.add()
   ...
   # Needed to send if ack_timeout_ns > 0 
    ...
    # def ReadDigests(self, digest_id=None, dry_run=False):
    #     request = p4runtime_pb2.ReadRequest()
    #     request.device_id = self.device_id
    #     entity = request.entities.add()
    #     digest_entry = entity.digest_entry
    #     if digest_id is not None:
    #         digest_entry.digest_id = digest_id
    #     else:
    #         counter_entry.digest_id = 1 
